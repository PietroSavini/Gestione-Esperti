            ...
            <Paper className={className} sx={{ padding: '1rem 1rem' }} elevation={2}>
                ...
                <Grid container sx={{ marginBottom: '1rem' }}>
                    <Grid padding={'0 1rem'} item xs={12} md={6}>
                        <Custom_TextField {...register('classe-documentale')} label='Classe Documentale' disabled value={'Bandi di Gara'} />
                    </Grid>
                    <Grid padding={'0 1rem'} item xs={12} md={6}>
                        <Custom_Select
                    ...
                    <Grid padding={'0 1rem'} item xs={12}>
                        <Custom_Select {...register('tipologia-esperto')} options={options.select2} label='Tipologia Esperto' defaultValue={''} />
                    </Grid>
                </Grid>
                <Divider />
                ...
                <Grid container sx={{ marginBottom: '1rem' }}>
                    <Grid padding={'0 1rem'} item xs={12} md={3}>
                        <Custom_TextField {...register('anno-di-riferimento')} label='Anno di Riferimento' disabled value={'2024'} />
                    </Grid>
                    <Grid padding={'0 1rem'} item xs={12} md={3}>
                        <Custom_Select {...register('a-o-o')} options={options.aoo} label='A.O.O' defaultValue={'NUOVA AOO'} />
                    </Grid>
                    <Grid padding={'0 1rem'} item xs={12} md={3}>
                        <Custom_Select {...register('archivio-di-collocazione')} options={options.adc} label='Archivio di Collocazione' defaultValue={'1'} />
                    </Grid>
                    <Grid padding={'0 1rem'} item xs={12} md={3}>
                        <Custom_Select {...register('classe-addizionale')} options={options.select2} label='Classe addizionale' defaultValue={''} />
                    </Grid>
                    <Grid padding={'0 1rem'} item xs={12}>
                        <Custom_TextField  {...register('descrizione-estesa')} multiline minRows={4} label='Descrizione estesa/oggetto' placeholder='Scrivi un eventuale descrizione estesa...' />
                    </Grid>
                    <Grid padding={'0 1rem'} item xs={12}>
                        <Custom_TextField {...register('tag-documento')} label='Tag documento (min. 2 max. 20 caratteri)' placeholder='Inserisci tag...' />
                    </Grid>
                </Grid>
            </Paper>
        </>
